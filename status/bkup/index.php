        ...
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                ...
                <div class="pull-right" hidden>
                    <button class="btn btn-default btn-xs btn-filter" hidden><span></span> Cari Koleksi</button>
                </div>
            </div>
            <table class="table">
                <thead>
                ...
                <tbody>
							<?php
								...
								$ndelok = "
								SELECT pinjam.NO, anggota.NAMA, pinjam.JUDUL, pinjam.TGL
								FROM pinjam
								INNER JOIN anggota
                    ...
                    <tr>
						...
						<td><a href="jos.php?NO=<?php echo $dadi["NO"]; ?>" ><button>HAPUS</button></a></td>
                    </tr>
							<?php
								}
							?>
