     ...
     <div class="row">
        <div class="panel panel-primary filterable">
            ...
            <table class="table">
                <thead>
                    <tr class="filters">
						<th hidden><input type="text" class="form-control" placeholder="CODE" disabled></th>
						...
						<th><input type="text" class="form-control" placeholder="Kembalikan" disabled></th>	
                    </tr>
                </thead>
                <tbody>
							<?php
								...
								$ndelok = "
								SELECT pinjam.CODE, pinjam.NO, anggota.NAMA, pinjam.JUDUL, pinjam.TGL
								FROM pinjam
								INNER JOIN anggota
							...
							?>
                    <tr>
						<td hidden><?php echo $dadi['CODE']; ?></td>
                        <td><?php echo $dadi['NAMA']; ?></td>
                        <td><?php echo $dadi['JUDUL']; ?></td>
                        <td><?php echo $dadi['TGL']; ?></td>
						<td><a href="hs/hs.php?CODE=<?php echo $dadi["CODE"]; ?>" ><button>Kembalikan</button></a></td>
                    </tr>
							<?php
								}
							?>
