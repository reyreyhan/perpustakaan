            ...
            <table class="table">
                <thead>
                    <tr class="filters">
						...
						<th><input type="text" class="form-control" placeholder="Tanggal Kembali" disabled></th>
                    </tr>
                </thead>
                <tbody>
							<?php
								...
								$ndelok = "
								SELECT anggota.NAMA, pengembalian.JUDUL, pengembalian.TGL, pengembalian.TGLB
								FROM pengembalian
								INNER JOIN anggota
								ON pengembalian.NIS=anggota.NIS
								";
