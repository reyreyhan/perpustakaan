     ...
     <div class="row">
        <div class="panel panel-primary filterable">
            ...
            <table class="table">
                <thead>
                    <tr class="filters">
                        <th><input type="text" class="form-control" placeholder="NIS" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Nama" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Jurusan" disabled></th>
                 <!--       <th><input type="text" class="form-control" placeholder="Hapus" disabled></th> -->
                    </tr>
                </thead>
                <tbody>
							<?php
								$ndelok = "SELECT * FROM anggota";
							...
							?>
                    <tr>
                        <td><a href="detail.php?NIS=<?php echo $dadi["NIS"]; ?>" ><?php echo $dadi['NIS']; ?></a></td>
                        <td><?php echo $dadi['NAMA']; ?></td>
                        <td><?php echo $dadi['JURUSAN']; ?></td>
                   <!--     <td><a href="jos.php?NIS=<?php // echo $dadi["NIS"]; ?>" ><button>Hapus</button></a></td> -->
