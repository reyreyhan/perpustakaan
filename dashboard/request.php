     ...
     <div class="row">
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                <h3 class="panel-title">List Saran & Request</h3>
            ...
            <table class="table">
                <thead>
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="Komentar" disabled></th>
                    </tr>
                </thead>
                <tbody>
							<?php
								$ndelok = "SELECT * FROM saran";
