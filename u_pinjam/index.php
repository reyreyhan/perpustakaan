     ...
     <div class="row">
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                <h3 class="panel-title">Koleksi Buku Kami</h3>
            ...
            <table class="table">
                <thead>
                    <tr class="filters">
						...
						<th><input type="text" class="form-control" placeholder="Pinjam" disabled></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $dadi['KATEGORI']; ?></td>
                        <td><?php echo $dadi['TAHUN']; ?></td>
						<td><a href="wew/pin.php?CODE=<?php echo $dadi["CODE"]; ?>" ><button>PINJAM</button></a></td>
                    </tr>
							<?php
								}
							?>
